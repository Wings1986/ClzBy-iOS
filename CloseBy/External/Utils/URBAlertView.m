...
//	_strokeColor = [UIColor colorWithWhite:0.8 alpha:1.000];
    _strokeColor = [UIColor colorWithRed:0.0f/255.0f green:163.f/255.0f blue:232.0f/255.0f alpha:1.0f];
	_strokeWidth = 3.0;
	_cornerRadius = 6.0;
	
	_titleFont = [UIFont fontWithName:@"AvantGardeITCbyBT-Book" size:18.0];
//	_titleColor = [UIColor whiteColor];
//    _titleShadowColor = [UIColor blackColor];
//    _titleShadowOffset = CGSizeMake(0.0, -1.0);
//    _titleColor = [UIColor blackColor];
    _titleColor = [UIColor colorWithRed:0.0f/255.0f green:163.f/255.0f blue:232.0f/255.0f alpha:1.0f];
    _titleShadowColor = [UIColor blackColor];
	_titleShadowOffset = CGSizeMake(0.0, 0.0);
	
	_messageFont = [UIFont fontWithName:@"AvantGardeITCbyBT-Book" size:14.0];
...
//    _messageColor = [UIColor blackColor];
    _messageColor = [UIColor colorWithRed:0.0f/255.0f green:163.f/255.0f blue:232.0f/255.0f alpha:1.0f];
    _messageShadowColor = [UIColor blackColor];
	_messageShadowOffset = CGSizeMake(0.0, 0.0);
	
//	_buttonBackgroundColor = [UIColor colorWithWhite:0.35 alpha:1.0];
    _buttonBackgroundColor = [UIColor colorWithWhite:1.0 alpha:1.0];
...
- (NSInteger)addButtonWithTitle:(NSString *)title {	
	...
	button.titleLabel.font = [UIFont fontWithName:@"AvantGardeITCbyBT-Book" size:15.0];
...
{
    m_nCurrentType = indexSelected;
    
    TNCircularRadioButtonData *radio1 = [TNCircularRadioButtonData new];
    radio1.labelText = @"Flash Special";
    radio1.identifier = @"2";
    radio1.selected = indexSelected == 2 ? YES : NO;
    radio1.labelColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio1.borderColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio1.circleColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio1.borderRadius = 20;
    radio1.circleRadius = 10;
    
    
    TNCircularRadioButtonData *radio2 = [TNCircularRadioButtonData new];
    radio2.labelText = @"Business Info";
    radio2.identifier = @"1";
    radio2.selected = indexSelected == 1 ? YES : NO;
    radio2.labelColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio2.borderColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio2.circleColor = [UIColor colorWithRed:0.0f/255.0f green:163.0f/255.0f blue:232.0f/255.0f alpha:1.0f];
    radio2.borderRadius = 20;
    radio2.circleRadius = 10;
    

    radioGroup = [[TNRadioButtonGroup alloc] initWithRadioButtonData:@[radio1, radio2] layout:TNRadioButtonGroupLayoutVertical];
    radioGroup.identifier = @"group";
    [radioGroup create];
...
- (void)layoutComponents {
    ...
    if (radioGroup != nil) {
        layout.textFieldsRect = CGRectMake(kURBAlertPadding, minY, layoutWidth - kURBAlertPadding * 2, textFieldsHeight +
                                           kURBAlertButtonHeight + kURBAlertButtonPadding + 16);
    }
    ...
    if (radioGroup != nil) {
        radioGroup.position = CGPointMake(50, CGRectGetMinY(layout.textFieldsRect)+kURBAlertButtonPadding+8);
...
- (void)drawText:(NSString *)text inRect:(CGRect)rect font:(UIFont *)font color:(UIColor *)color shadowColor:(UIColor *)shadowColor shadowOffset:(CGSize)shadowOffset {
	if (text.length > 0) {
		...
		if (!font) font = [UIFont fontWithName:@"AvantGardeITCbyBT-Book" size:12.0];;
...
//        _textColor = [UIColor blackColor];
        _textColor = [UIColor colorWithRed:0.0f/255.0f green:163.f/255.0f blue:232.0f/255.0f alpha:1.0f];
	}
	return self;
}
...
//	UIColor *buttonInnerGradientColor2 = [self.backgroundColor adjustBrightness:0.95];
    UIColor *buttonBgGradientColorTop = [UIColor colorWithWhite:1.0 alpha:1.0];
    UIColor *buttonBgGradientColorBottom = [UIColor colorWithWhite:1.0 alpha:1.0];
    UIColor *buttonOuterGradientColor = [self.strokeColor adjustBrightness:1.05];
    UIColor *buttonOuterGradientColor2 = [self.strokeColor adjustBrightness:0.95];
    UIColor *buttonInnerGradientColor = [self.backgroundColor adjustBrightness:1.05];
    UIColor *buttonInnerGradientColor2 = [self.backgroundColor adjustBrightness:0.95];
	...
	// outer drawing
	CGRect buttonOuterRect = CGRectInset(frame, 2.0, 2.0);
	...
	// inner drawing
	CGRect buttonInnerRect = CGRectInset(frame, 3.0, 3.0);
    ...
    return [image resizableImageWithCapInsets:UIEdgeInsetsMake(topInset, 3.0, topInset, 3.0)];
}
