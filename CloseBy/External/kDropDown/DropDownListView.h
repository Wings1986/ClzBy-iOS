...
- (id)initWithTitle:(NSString *)aTitle options:(NSArray *)aOptions indexData:(NSArray*)aIndex key:(NSString*)keyValue xy:(CGPoint)point size:(CGSize)size isMultiple:(BOOL)isMultiple;// If animated is YES, PopListView will be appeared with FadeIn effect.
