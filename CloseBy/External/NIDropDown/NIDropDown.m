...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        ...
        cell.textLabel.font = [UIFont fontWithName:@"AvantGardeITCbyBT-Book" size:14.0];
        cell.textLabel.textAlignment = NSTextAlignmentCenter;
    }
    
    button = (UIButton*)[cell viewWithTag:indexPath.row + 10000];
    if (button == nil) {
...
- (void) myDelegate:(NSInteger) row {
    [self.delegate niDropDownDelegateMethod:self index:row];
}
